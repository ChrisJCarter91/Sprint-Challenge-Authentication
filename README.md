...
It gives a user a unique id to confirm authentication

1. What does bcrypt do to help us store passwords in a secure manner.

Bcrypt uses a one-way hash password and makes it so passwords aren't stored in plain text. 

1. What does bcrypt do to slow down attackers?

It encrypts the password however many times we specify to make it extremely unique and hard to crack.
